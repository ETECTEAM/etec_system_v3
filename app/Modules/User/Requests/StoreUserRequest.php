...
class StoreUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'shift_preference' => ['nullable', Rule::in(['morning_evening', 'afternoon_evening', 'morning_afternoon'])],
