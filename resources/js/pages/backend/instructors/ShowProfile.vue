  ...
  <DashboardLayout>
    <section class="space-y-6">
      ...
      <div v-else class="rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <p class="mt-1 text-sm text-slate-500 dark:text-gray-400">Please complete your profile to get started.</p>
        <Link
          href="/dashboard/instructor/profile"
      ...
      <div v-if="instructorData" class="grid gap-6 lg:grid-cols-2">
        ...
        <div class="space-y-6">
          ...
          <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex items-center justify-between">
              <h3 class="text-base font-semibold text-slate-900 dark:text-gray-100">Personal Information</h3>
            ...
            <div class="mt-4 space-y-3">
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">Full Name</span>
                <span class="font-medium text-slate-900 dark:text-gray-100">{{ instructorData.full_name ?? 'Not provided' }}</span>
              </div>
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">Email</span>
              ...
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">Date of Birth</span>
                <span class="font-medium text-slate-900 dark:text-gray-100">{{ instructorData.date_of_birth ?? 'Not provided' }}</span>
              </div>
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">Gender</span>
              ...
              <div class="flex justify-between pb-2 text-sm">
                <span class="text-slate-500 dark:text-gray-400">Address</span>
          ...
          <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex items-center justify-between">
              <h3 class="text-base font-semibold text-slate-900 dark:text-gray-100">Social Links</h3>
              <Link href="/dashboard/instructor/profile" class="text-blue-900 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
              </Link>
            </div>
            <div class="mt-4 space-y-3">
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">Telegram</span>
                ...
                <span v-else class="text-slate-400 dark:text-gray-500">Not provided</span>
              </div>
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">LinkedIn</span>
              ...
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">GitHub</span>
              ...
              <div class="flex justify-between pb-2 text-sm">
                <span class="text-slate-500 dark:text-gray-400">Portfolio</span>
        ...
        <div class="space-y-6">
          ...
          <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex items-center justify-between">
              <h3 class="text-base font-semibold text-slate-900 dark:text-gray-100">Employment Information</h3>
              <Link href="/dashboard/instructor/profile" class="text-blue-900 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
              </Link>
            </div>
            <div class="mt-4 space-y-3">
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">Instructor Code</span>
                <span class="font-mono font-medium text-slate-900 dark:text-gray-100">{{ instructorData.instructor_code ?? 'Not provided' }}</span>
              </div>
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">Employment Type</span>
              ...
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">Shift Template</span>
                <span class="font-medium text-slate-900 dark:text-gray-100">{{ shiftTemplate?.name ?? 'Not assigned' }}</span>
              </div>
              <div class="flex justify-between border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="text-slate-500 dark:text-gray-400">Available for Class</span>
          ...
          <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex items-center justify-between">
              <h3 class="text-base font-semibold text-slate-900 dark:text-gray-100">Profile Details</h3>
              <Link href="/dashboard/instructor/profile" class="text-blue-900 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
              </Link>
            </div>
            <div class="mt-4 space-y-3">
              <div class="border-b border-slate-100 pb-2 text-sm dark:border-gray-800">
                <span class="block text-slate-500 dark:text-gray-400">Headline</span>
                <p class="mt-0.5 font-medium text-slate-900 dark:text-gray-100">{{ instructorData.headline ?? 'Not provided' }}</p>
              </div>
              <div class="pb-2 text-sm">
                <span class="block text-slate-500 dark:text-gray-400">Bio</span>
          ...
          <!-- Attachments -->
          <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <h3 class="text-base font-semibold text-slate-900 dark:text-gray-100">Attachments</h3>
            <div class="mt-4 space-y-3">
              <div class="flex items-center gap-3 rounded-lg border border-slate-100 bg-slate-50 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <span class="text-slate-600 dark:text-gray-300">Profile Photo</span>
                <span v-if="profilePhoto?.url" class="ml-auto text-xs text-emerald-600 dark:text-emerald-400">Uploaded</span>
                <span v-else class="ml-auto text-xs text-slate-400 dark:text-gray-500">Not uploaded</span>
              </div>
              ...
              <div class="flex items-center gap-3 rounded-lg border border-slate-100 bg-slate-50 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <span class="text-slate-600 dark:text-gray-300">CV / Resume</span>
                <a
                  v-if="cvFile?.url"
                  :href="cvFile.url"
                  target="_blank"
              ...
              <p v-if="!profilePhoto && !cvFile && otherAttachments.length === 0" class="text-sm text-slate-400 dark:text-gray-500">No attachments uploaded yet.</p>
            </div>
          </div>
        </div>
      </div>
