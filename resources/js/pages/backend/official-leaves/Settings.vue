...
<template>
  <DashboardLayout>
    <section class="space-y-6">
      ...
      <PageHero :eyebrow="$t('Super Admin')" :title="$t('Leave Settings')" :description="$t('Student leave & permission requests — monthly quota and the leave-request QR link lifetime.')" />
