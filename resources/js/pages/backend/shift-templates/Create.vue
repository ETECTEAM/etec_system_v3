      ...
      <div class="w-full rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 dark:border-gray-800 dark:bg-gray-900">
        <form @submit.prevent="submit" class="space-y-6">
          <div class="grid gap-4 sm:grid-cols-2">
            <div>
              <label class="mb-2 block text-sm font-semibold text-slate-700 dark:text-gray-200">Name <span class="text-red-500">*</span></label>
              <input ref="inputRef" v-model="form.name" type="text" class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none transition focus:border-blue-900 focus:ring-2 focus:ring-blue-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-blue-500 dark:focus:ring-blue-500/20" placeholder="e.g. Morning & Afternoon" />
              <p v-if="form.errors.name" class="mt-1 text-xs text-red-600 dark:text-red-400">{{ form.errors.name }}</p>
            </div>
            <div>
              <label class="mb-2 block text-sm font-semibold text-slate-700 dark:text-gray-200">Code <span class="text-red-500">*</span></label>
              <input v-model="form.code" type="text" class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none transition focus:border-blue-900 focus:ring-2 focus:ring-blue-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-blue-500 dark:focus:ring-blue-500/20" placeholder="e.g. morning_afternoon" />
              <p v-if="form.errors.code" class="mt-1 text-xs text-red-600 dark:text-red-400">{{ form.errors.code }}</p>
            </div>
            <div>
              <label class="mb-2 block text-sm font-semibold text-slate-700 dark:text-gray-200">Employment Type</label>
            ...
            <div>
              <label class="mb-2 block text-sm font-semibold text-slate-700 dark:text-gray-200">Active</label>
          ...
          <div>
            <label class="mb-2 block text-sm font-semibold text-slate-700 dark:text-gray-200">Description</label>
            <textarea v-model="form.description" class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none transition focus:border-blue-900 focus:ring-2 focus:ring-blue-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-blue-500 dark:focus:ring-blue-500/20" rows="2" placeholder="Optional description"></textarea>
          </div>

          <div class="border-t border-slate-200 pt-6 dark:border-gray-800">
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-base font-bold text-slate-900 dark:text-gray-100">Time Blocks <span class="text-red-500 dark:text-red-400">*</span></h3>
              <button type="button" @click="addBlock" class="text-sm font-semibold text-blue-700 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">+ Add Block</button>
            </div>
            ...
            <div v-for="(block, i) in form.blocks" :key="i" class="flex flex-wrap items-end gap-3 mb-3 p-4 rounded-xl bg-slate-50 border border-slate-200 dark:bg-gray-800 dark:border-gray-700">
              <div class="flex-1 min-w-[130px]">
                <label class="mb-1 block text-xs font-semibold text-slate-600 dark:text-gray-400">Day</label>
              ...
              <div class="flex-1 min-w-[110px]">
                <label class="mb-1 block text-xs font-semibold text-slate-600 dark:text-gray-400">Period</label>
                <input v-model="block.period" type="text" class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none focus:border-blue-900 focus:ring-2 focus:ring-blue-100 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-200 dark:focus:border-blue-500 dark:focus:ring-blue-500/20" placeholder="e.g. morning" />
              </div>
              <div class="w-[120px]">
                <label class="mb-1 block text-xs font-semibold text-slate-600 dark:text-gray-400">Start</label>
              ...
              <div class="w-[120px]">
                <label class="mb-1 block text-xs font-semibold text-slate-600 dark:text-gray-400">End</label>
