...
@media print { @page { size: letter portrait; margin: 0; } body { background: #fff !important; } .no-print { display: none !important; } .certificate-page { display: block; padding: 0 !important; } .certificate-preview-wrap { overflow: visible; padding: 0; background: #fff; box-shadow: none; } .certificate-sheet { box-shadow: none; } }
</style>
