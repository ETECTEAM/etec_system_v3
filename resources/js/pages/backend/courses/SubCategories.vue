    ...
    <DashboardLayout>
        <div class="w-full">
            ...
            <nav class="flex items-center gap-1.5 text-sm text-slate-400 mb-4">
                ...
                <span class="text-slate-600 font-medium">{{ $t('Sub Categories') }}</span>
            </nav>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-slate-900 tracking-tight">{{ $t('Sub Categories') }}</h1>
                        <p class="text-sm text-slate-500 mt-0.5">{{ $t('Read, create, update, and delete sub category records') }}</p>
                    </div>
                </div>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            <tr v-if="paginatedSubCategories.length === 0 && subCategories.length === 0">
                                <td colspan="6" class="px-4 py-16 text-center">
                                    ...
                                    <p class="text-sm font-medium text-slate-600">{{ $t('No sub categories yet') }}</p>
                                    <p class="text-xs text-slate-400 mt-1">{{ $t('Create your first sub category to start organizing courses') }}</p>
                                    <Link href="/dashboard/course/subcategories/create"
        ...
        <div v-if="showDeleteModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-[2px]"
            ...
            <div class="bg-white rounded-2xl p-6 max-w-md w-full mx-4 shadow-xl">
                <div class="flex items-start gap-4 mb-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900">{{ $t('Delete sub category') }}</h3>
