        ...
        <div class="p-4 sm:p-6">
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
                <div class="flex items-center gap-3">
                    <Link href="/dashboard/course/categories" class="text-slate-500 hover:text-slate-700 transition p-1.5 rounded-lg hover:bg-slate-100" title="Back">
                ...
                <span v-if="category" class="text-sm text-slate-500 bg-slate-100 px-3 py-1 rounded-full">
                    ID: #{{ category.id }}
                </span>
            </div>
