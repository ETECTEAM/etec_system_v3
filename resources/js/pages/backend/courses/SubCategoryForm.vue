    ...
    <DashboardLayout>
        <!-- Breadcrumb -->
            <nav class="flex items-center gap-1.5 text-sm text-slate-400 mb-4">
                ...
                <span class="text-slate-400 font-medium">Sub Categories</span>
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
        ...
        <div class="p-4 sm:p-6">
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
                <div class="flex items-center gap-3">
                    <Link href="/dashboard/course/subcategories" class="text-slate-500 hover:text-slate-700 transition p-1.5 rounded-lg hover:bg-slate-100" title="Back">
                ...
                <span v-if="subCategory" class="text-sm text-slate-500 bg-slate-100 px-3 py-1 rounded-full">
                    ID: #{{ subCategory.id }}
                </span>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-lg border border-slate-200 p-4 sm:p-6 shadow-sm">
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <p v-if="errors.category_id" class="mt-1.5 text-sm text-red-600 flex items-center gap-1">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-slate-500">Auto-generated from the sub category name</p>
                    </div>
