...
<template>
  ...
  <DashboardLayout>
    <section class="space-y-6">
      <PageHero eyebrow="Building Management" title="Create Building" description="Add a new building before assigning floors and rooms." />
      ...
      <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <form class="grid gap-5 sm:grid-cols-2" @submit.prevent="submit">
          ...
          <label class="block">
            ...
            <input placeholder="optional"  v-model="form.code" type="text" class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none transition focus:border-blue-600 focus:ring-2 focus:ring-blue-100">
          ...
          <label class="block sm:col-span-2">
            ...
            <input placeholder="optional" v-model="form.address" type="text" class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none transition focus:border-blue-600 focus:ring-2 focus:ring-blue-100">
          ...
          <label class="block sm:col-span-2">
            ...
            <textarea placeholder="optional" v-model="form.description" rows="5" class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none transition focus:border-blue-600 focus:ring-2 focus:ring-blue-100"></textarea>
