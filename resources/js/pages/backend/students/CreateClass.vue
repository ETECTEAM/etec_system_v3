...
<template>
    ...
    <DashboardLayout>
        <div
            :class="{
                'pointer-events-none cursor-wait opacity-70': form.processing,
            }"
        ...
        >
            ...
            <div class="flex items-center justify-between">
                <div
                    class="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-indigo-100 sm:h-14 sm:w-14"
                >
                    <GraduationCap
                        class="h-6 w-6 text-indigo-600 sm:h-7 sm:w-7"
                    />
                </div>
                ...
                <button
                    type="button"
                    @click="back"
                    class="flex items-center gap-2 whitespace-nowrap rounded-xl border border-slate-300 px-4 py-2.5 text-sm transition hover:bg-slate-100 sm:px-5 sm:py-3 sm:text-base"
                >
