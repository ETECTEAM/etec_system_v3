         ...
         <Breadcrumbs :items="breadcrumbItems" />
          <PageHero/>
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
                ...
                <button @click="back" class="inline-flex items-center justify-center gap-2 rounded-xl  bg-blue-900 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-800">
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-slate-200 p-4 sm:p-6 lg:p-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
                    ...
                    <div>
                        ...
                        <select v-model="form.building" class="w-full rounded-xl border border-slate-300 px-4 py-3">
                            <option>
                                Building A
                            </option>
                            <option>
                    ...
                    <div>
                        ...
                        <select v-model="form.floor" class="w-full rounded-xl border border-slate-300 px-4 py-3">
                            <option>
                                Floor 1
                            </option>
                            <option>
                    ...
                    <div>
                        ...
                        <input v-model="form.room" class="w-full rounded-xl border border-slate-300 px-4 py-3" placeholder="B101"/>
                    </div>
                    ...
                    <div>
                        ...
                        <input  v-model="form.term" class="w-full rounded-xl border border-slate-300 px-4 py-3" placeholder="Mon & Thu"/>
                    </div>
                    ...
                    <div>
                        ...
                        <input v-model="form.time" class="w-full rounded-xl border border-slate-300 px-4 py-3" placeholder="09:00 AM - 10:30 AM"/>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" min="1" v-model="form.capacity" class="w-full rounded-xl border border-slate-300 px-4 py-3"/>
                    </div>

                    <div>
                        <label class="font-semibold mb-2 block">Price</label>
                        <input type="number" min="1" v-model="form.price" class="w-full rounded-xl border border-slate-300 px-4 py-3"/>
                    </div>

                    <div>
                        <label class="font-semibold mb-2 block">Start EnRoll</label>
                        <input type="date" min="1" v-model="form.startEnroll" class="w-full rounded-xl border border-slate-300 px-4 py-3"/>
                    </div>

                    <div>
                        <label class="font-semibold mb-2 block">Start Date</label>
                        <input type="date" min="1" v-model="form.startDate" class="w-full rounded-xl border border-slate-300 px-4 py-3"/>
                    </div>
                </div>
                <!-- Footer -->
