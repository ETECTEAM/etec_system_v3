                ...
                >
                    ...
                    <div class="flex items-center justify-between px-5 sm:px-6 pt-5 sm:pt-6 pb-4">
                        <div class="flex items-start gap-3 min-w-0">
                            <div class="shrink-0 flex items-center justify-center w-10 h-10 rounded-xl bg-indigo-50 text-indigo-600 ring-1 ring-indigo-100">
                        ...
                        <button
                            type="button"
                            @click="emit('close')"
                            class="shrink-0 p-2 rounded-xl text-slate-400 hover:text-slate-600 hover:bg-slate-100 active:bg-slate-200 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
                    ...
                    <div class="px-3 sm:px-4 pb-2 space-y-0.5">
                        <button
                            ...
                            class="flex items-center gap-3 w-full px-3 py-2.5 sm:py-3 rounded-xl text-sm font-medium text-slate-700 hover:bg-indigo-50 hover:text-indigo-700 active:bg-indigo-100 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
                        >
                            <component :is="item.icon" class="w-4 h-4 shrink-0 text-slate-400 group-hover:text-indigo-500" />
                            <span>{{ item.label }}</span>
                        </button>
                    </div>

                    <!-- ─── Divider ─── -->
                    <div class="mx-5 sm:mx-6 my-2 border-t border-slate-100"></div>

                    <!-- ─── Danger Zone ─── -->
                    <div class="px-3 sm:px-4 pb-3 sm:pb-4 space-y-0.5">
                        <p class="px-3 pt-1 pb-1.5 text-xs font-semibold uppercase tracking-wider text-slate-400">
                            Danger Zone
                        </p>
                        <button
                            ...
                            :class="[
                                ...
                                item.danger === 'critical'
                                    ...
                                    : 'text-amber-600 hover:bg-amber-50 active:bg-amber-100 focus-visible:ring-amber-500',
                            ]"
                        >
                            <component :is="item.icon" :class="[
                                'w-4 h-4 shrink-0',
                                item.danger === 'critical' ? 'text-red-500' : 'text-amber-500',
                            ]" />
