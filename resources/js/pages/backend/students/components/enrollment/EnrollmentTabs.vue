...
<template>
  <div class="-mx-1 flex justify-center overflow-x-auto px-1">
    <div
      class="inline-flex gap-1 rounded-xl border border-slate-200 bg-slate-100 p-1 dark:border-gray-800 dark:bg-gray-800/60"
      role="tablist"
    >
      <button
        v-for="tab in tabs"
        ...
        :class="[
          'relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg px-4 py-2 text-sm font-semibold transition',
          modelValue === tab.key
