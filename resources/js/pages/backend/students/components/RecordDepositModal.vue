...
<template>
  <div v-if="show && enrollment" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 px-4">
    <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl dark:bg-gray-900">
      <h3 class="text-lg font-semibold text-slate-900 dark:text-gray-100">Record Deposit</h3>
      ...
      <div class="mt-4">
        <label class="mb-2 block text-sm font-semibold text-slate-700 dark:text-gray-300">Deposit Amount</label>
