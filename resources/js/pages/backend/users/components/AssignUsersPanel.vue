  ...
  <form class="self-start rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900" @submit.prevent="saveAssignedUsers">
    <div class="border-b border-slate-200 p-5 dark:border-gray-800">
      <div class="flex items-start justify-between gap-3">
        ...
        <button type="submit" :disabled="!selectedRole || assignUsersForm.processing" class="shrink-0 rounded-lg bg-blue-900 px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-70">{{ assignUsersForm.processing ? 'Assigning...' : 'Assign User' }}</button>
      </div>
