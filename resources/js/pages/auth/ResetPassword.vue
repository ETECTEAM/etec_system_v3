...
<template>
  <AuthCard>
    <div class="mb-8">
      <h2 class="text-3xl font-black text-slate-900 dark:text-gray-100">Reset Password</h2>
      <p class="mt-2 text-sm text-slate-600 dark:text-gray-400">Choose a new password for your account.</p>
    </div>
