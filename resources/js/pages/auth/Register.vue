...
<template>
  <AuthCard>
    <div class="mb-8">
      <h2 class="text-3xl font-black text-slate-900 dark:text-gray-100">Create Account</h2>
      <p class="mt-2 text-sm text-slate-600 dark:text-gray-400">Register to access the dashboard.</p>
    </div>
